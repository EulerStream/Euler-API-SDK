...
```python
from EulerApiSdk.models import MyDataModel
from EulerApiSdk.api.my_tag import get_my_data_model
from EulerApiSdk.types import Response
...
1. Any endpoint which did not have a tag will be in `EulerApiSdk.api.default`
