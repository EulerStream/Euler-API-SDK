...
from ...models.stream_type import StreamType
...
def _get_kwargs(
    *,
    ...
    json_stream_type: str | Unset = UNSET
    if not isinstance(stream_type, Unset):
        json_stream_type = stream_type.value

    params["streamType"] = json_stream_type

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/webcast/room_video",
        "params": params,
    }
